...
public class VirtualJoystickLimit : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public virtual void OnDrag (PointerEventData ped)
    {
        ...
        smallStick.transform.position = new Vector3(
Mathf.Clamp(bigStick.transform.position.x , -0.0f , 0.0f) ,
Mathf.Clamp(bigStick.transform.position.y , -0.0f , 0.0f) , 0);
        Debug.Log(smallStick.transform.position);
